...
def draw_scatter_plot(x_values, algo2results):
    ...
    xlabel = plt.xlabel("Average overlapping")
    ...
    plt.tight_layout()
    savefig("../paper/imgs/4_time_avg_overlapping.eps", transparent="True", pad_inches=0)
...
if 1:
    query_len_results = load_data("../test_results/avg_overlapping.txt")
